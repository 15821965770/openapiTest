 ...
 * 
 */
@WebServiceClient(name = "ISayHelloImplService", targetNamespace = "http://it.com/", wsdlLocation = "http://localhost:8888/vip/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ISAYHELLOIMPLSERVICE_QNAME = new QName("http://it.com/", "ISayHelloImplService");
    ...
    public ISayHelloImpl getISayHelloImplPort() {
        return super.getPort(new QName("http://it.com/", "ISayHelloImplPort"), ISayHelloImpl.class);
    }
    ...
    public ISayHelloImpl getISayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://it.com/", "ISayHelloImplPort"), ISayHelloImpl.class, features);
    }
